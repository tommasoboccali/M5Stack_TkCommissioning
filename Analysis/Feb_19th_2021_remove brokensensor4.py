...
#i do not consider sensor 4
delta_T_Above_minus_below = ( (my_curated_data[:,2]+my_curated_data[:,2])-(my_curated_data[:,4]+my_curated_data[:,9]) ) / 2
...
plt.savefig("Feb_19th_2021_removedbroken4.png")
